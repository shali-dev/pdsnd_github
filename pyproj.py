...
def get_filters():
    ...
    while True:
      ...
      if month not in ( 'january', 'febraury', 'march', 'april', 'may', 'june','all'):
...
def load_data(city, month, day):
    ...
    return df
    # Displays the most frequent time of travel
def time_stats(df):
...
def main():
    while True:
        ...
        """To display raw data"""
        user_input=input("\nDo you want to see five rows of data? Enter yes or no:\n").lower()
